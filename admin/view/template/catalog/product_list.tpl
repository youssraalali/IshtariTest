        ...
        <table class="list">
          <thead>
            <tr>
              ...
              <!-- Cost column header with sorting -->
              <td class="left">
                <?php if ($sort == 'p.cost') { ?>
              ...
              <!-- profit column with sorting -->
              <td class="left">
                <?php if ($sort == 'profit') { ?>
                  <a href="<?php echo $sort_profit; ?>" class="<?php echo strtolower($order); ?>">Profit</a>
                <?php } else { ?>
                  <a href="<?php echo $sort_profit; ?>">Profit</a>
                <?php } ?>
              </td>
          ...
          <tbody>
            <tr class="filter">
              ...
              <td align="left"><input type="text" name="filter_quantity" value="<?php echo $filter_quantity; ?>" style="text-align: right;" /></td>
              <!-- filter Cost -->
              <td>
                <input type="text" name="filter_cost"
                  value="<?php echo isset($filter_cost) ? htmlspecialchars_decode($filter_cost) : ''; ?>
                " size="10" placeholder=">3, <=10 etc" />
              </td>
              <td>
                <input type="text" name="filter_profit"
                  value="<?php echo isset($filter_profit) ? htmlspecialchars_decode($filter_profit) : ''; ?>" />
              </td>
              <td>
                <select name="filter_category_id">
                  <option value="">--All Categories--</option>
                  <?php
                  foreach ($categories_paths as $cat) { ?>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    foreach ($product['paths'] as $path) { ?>
                      <div class="left"><?php echo $path; ?></div>
                    <?php } ?>
                  </td>
...
<script type="text/javascript">
  ...
  function filter() {
    ...
    if (filter_cost && filter_cost.trim() !== '') {
      url += '&filter_cost=' + encodeURIComponent(filter_cost.trim());
    }
    ...
    if (filter_profit && filter_profit.trim() !== '') {
      url += '&filter_profit=' + encodeURIComponent(filter_profit.trim());
    }
